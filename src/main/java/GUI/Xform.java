...
public class Xform extends Group {
    ...
    public void rotateX(double x) { rx.setAngle(rx.getAngle() + x); }
    public void rotateY(double y) { ry.setAngle(ry.getAngle() + y); }
    public void rotateZ(double z) { rz.setAngle(rz.getAngle() + z); }
